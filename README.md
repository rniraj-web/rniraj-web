...
3. Experience with JWT auth, role-based access, and secure REST APIs.
4. Comfortable with testing using Jest and React Testing Library.
5. Enjoy working in Agile teams with CI/CD and Dockerised workflows.
6. Always looking to learn more about frontend performance and DX.
